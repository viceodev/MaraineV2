            ...
            <div class="desktop-info d-none">
                <a href="{{route('student.assignments')}}">
                    <section>
                        ...
                        <span>{{count(session()->get('user_assignments')) ?? "0"}} Total </span>
                    </section>
                </a>

                <a href="{{route('student.assignments.status', 'unsubmitted')}}">
                    <section>
                        ...
                        <span>{{count($status['unsubmitted'])}} Unsubmitted</span>
                    </section>
                </a>

                <a href="{{route('student.assignments.status', 'submitted')}}">
                    <section>
                        <i>
...
<section class="right">
    ...
    <section class="header bg-white">
        <ul class="flex align-items-center">
            ...
            <a href="{{route('student.assignments.status', 'new')}}">
                <li class="flex-around align-items-center d-none">
                    <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M542.22 32.05c-54.8 3.11-163.72 14.43-230.96 55.59-4.64 2.84-7.27 7.89-7.27 13.17v363.87c0 11.55 12.63 18.85 23.28 13.49 69.18-34.82 169.23-44.32 218.7-46.92 16.89-.89 30.02-14.43 30.02-30.66V62.75c.01-17.71-15.35-31.74-33.77-30.7zM264.73 87.64C197.5 46.48 88.58 35.17 33.78 32.05 15.36 31.01 0 45.04 0 62.75V400.6c0 16.24 13.13 29.78 30.02 30.66 49.49 2.6 149.59 12.11 218.77 46.95 10.62 5.35 23.21-1.94 23.21-13.46V100.63c0-5.29-2.62-10.14-7.27-12.99z"/></svg></i>
                    <span>New <span class="assign">Assignments</span></span>
                </li>
            </a>
            ...
            <a href="{{route('student.assignments.status', 'unsubmitted')}}">
                <li class="flex-around align-items-center">
                    <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M542.22 32.05c-54.8 3.11-163.72 14.43-230.96 55.59-4.64 2.84-7.27 7.89-7.27 13.17v363.87c0 11.55 12.63 18.85 23.28 13.49 69.18-34.82 169.23-44.32 218.7-46.92 16.89-.89 30.02-14.43 30.02-30.66V62.75c.01-17.71-15.35-31.74-33.77-30.7zM264.73 87.64C197.5 46.48 88.58 35.17 33.78 32.05 15.36 31.01 0 45.04 0 62.75V400.6c0 16.24 13.13 29.78 30.02 30.66 49.49 2.6 149.59 12.11 218.77 46.95 10.62 5.35 23.21-1.94 23.21-13.46V100.63c0-5.29-2.62-10.14-7.27-12.99z"/></svg></i>
                    <span>Unsubmitted <span class="assign">Assignments</span></span>
                </li>
            </a>

            <a href="{{route('student.assignments.status', 'submitted')}}">
                <li class="flex-around align-items-center">
                    <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M448 360V24c0-13.3-10.7-24-24-24H96C43 0 0 43 0 96v320c0 53 43 96 96 96h328c13.3 0 24-10.7 24-24v-16c0-7.5-3.5-14.3-8.9-18.7-4.2-15.4-4.2-59.3 0-74.7 5.4-4.3 8.9-11.1 8.9-18.6zM128 134c0-3.3 2.7-6 6-6h212c3.3 0 6 2.7 6 6v20c0 3.3-2.7 6-6 6H134c-3.3 0-6-2.7-6-6v-20zm0 64c0-3.3 2.7-6 6-6h212c3.3 0 6 2.7 6 6v20c0 3.3-2.7 6-6 6H134c-3.3 0-6-2.7-6-6v-20zm253.4 250H96c-17.7 0-32-14.3-32-32 0-17.6 14.4-32 32-32h285.4c-1.9 17.1-1.9 46.9 0 64z"/></svg></i>
                    <span>Submitted <span class="assign">Assignments</span></span>
                </li>
            </a>
            <div class="tools">
 
                <a href="{{route('student.assignments.submit')}}">
                    <li class="flex-around align-items-center">
                        <i class="submit">
        ...
        <script>
            ...
            let changeDate =  function(){
                let lis = document.querySelectorAll('#assignment-date');
                let months = {'01': 'jan','02': 'feb','03': 'mar','04': 'apr','05': 'may','06': 'jun','06': 'jul','08': 'aug','09': 'sept','10': 'oct','11': 'nov','12': 'dec',};

                lis.forEach((li) => {
                    let content =  li.textContent;
                    let conArray = content.split('T')[0].split("-");

                    li.textContent = `${conArray[2]} ${months[conArray[1]]} ${conArray[0]}`;
                    li.style.opacity = "1";
            ...
            let active =  function(){
                let regex = ['show', 'new','unsubmitted', 'submitted', 'submit'];
