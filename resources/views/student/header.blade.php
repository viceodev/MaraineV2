...
<header class="desktop d-none shadow-sm">
    ...
    <form action="" method="POST" class="flex align-items-center" title="Search Maraine">
            <input type="text" name="search" id="search" placeholder="Search Maraine" class="shadow-sm fade">
            <button type="submit">
                <i>
    ...
    <section class="desktop-icon flex-around align-items-center" title="Home">
        <a href="{{route('student.home')}}" class="header-svg">
...
<section class="mobile_menu capitalize d-none" id="nav-modal">
