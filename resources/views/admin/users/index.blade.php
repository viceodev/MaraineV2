...
@if(count($courses) > 0)
    <section class=" mt-1 container capitalize">
        <p class="md bold center bg-white rounded shadow-ts p-1">Choose A level to view Users in</p>

        @foreach ($courses as $course)
            <ul class="p-1 container ul-hover card" style="margin: 20px auto;">

                <a href="{{route('users.show', $course['level'])}}">
                    <li class="flex-center align-items-center">
                        ...
                        <p class="md ml-1 mr-1">
                            See users in {{$course['level']}}  Level
                        </p>
